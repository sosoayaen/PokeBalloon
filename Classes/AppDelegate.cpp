...
{
    const char* pszShareSDKAppKey = NULL;
#if CC_PLATFORM_TARGET == CC_TARGET_IOS
    pszShareSDKAppKey = "1bc964e23aab";
#elif CC_PLATFORM_TARGET == CC_TARGET_ANDROID
    pszShareSDKAppKey = "1bc9b85ebea0";
#endif
    
    C2DXShareSDK::open(ccs(pszShareSDKAppKey), false);
