...
/*******************************************************************
 ...
 更 新 日 期：  2009.12.8
 *******************************************************************/
std::string bailin::util::base64_encode(unsigned char const* bytes_to_encode, unsigned int in_len)
{
    std::string ret;
    int i = 0;
    int j = 0;
...
/*******************************************************************
 ...
 更 新 日 期：  2009.12.8
 *******************************************************************/
std::string bailin::util::base64_decode(std::string const& encoded_string)
{
